                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('dob') is-invalid @enderror" name="dob" id="dateOfBirth" autocomplete="dob" placeholder="mm/dd/yyyy" autocomplete="off">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Profile') }}</label>
